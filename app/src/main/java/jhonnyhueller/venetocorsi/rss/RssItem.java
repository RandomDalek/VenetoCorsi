package jhonnyhueller.venetocorsi.rss;/*
...
public class RssItem implements Comparable<RssItem>, Parcelable {
    ...
    public static final int NOT_READ_FLAG =0;
	public static final int ALREADY_READ_FLAG=1;
    ...
    public String getDatabasePubDate() {
        return DateAdapter.formatDbFromDate(pubDate);
    }
}
